...
<div class="certification-card">
  <img src="/google-ai-essentials.png" alt="Google AI Essentials" class="cert-badge" />
  <div class="cert-info">
    <h4>Google AI Essentials</h4>
    <div class="cert-provider">Coursera • November 2024</div>
    <a href="https://www.credly.com/go/5SB7Z39c" target="_blank" class="cert-link">View Certificate →</a>
  </div>
</div>
...
<div class="learning-section">
  ...
  <div class="learning-items">
    <span class="learning-item">MCP (Model Context Protocol)</span>
    <span class="learning-item">AI Agentic Systems</span>
    <span class="learning-item">LLM Integration</span>
  </div>
</div>
